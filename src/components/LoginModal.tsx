      ...
      <div className="bg-white rounded-2xl max-w-md w-full p-6 relative">
        ...
        <div className="text-center">
          ...
          <button
            ...
            disabled={loading}
            className="w-full bg-white border-2 border-gray-300 hover:border-cyan-400 text-gray-700 py-3 px-4 rounded-lg font-medium transition-all duration-300 flex items-center justify-center space-x-3 mb-6 disabled:opacity-50 shadow-lg hover:shadow-xl"
          >
            {loading ? (
