  ...
  return (
    ...
    >
      {slides.map((slide, index) => (
        ...
        >
          {slide.isBanner ? (
            <div className={`w-full h-full flex items-center justify-center ${slide.image.includes('purple modern') || slide.image.includes('215601')
                ? 'bg-black'
