        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 py-4 sm:py-6 md:py-8">
          <div className="flex items-center justify-between mb-6 sm:mb-8">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <h1 className="text-xl sm:text-2xl md:text-3xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent">PC Games</h1>
            </div>
          </div>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-orange-50">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 py-4 sm:py-6 md:py-8">
          ...
          <div className="text-center py-12">
            <p className="text-red-600">Failed to load PC games. Please try again later.</p>
          </div>
        </div>
      </div>
    );
          ...
          <div className="lg:col-span-3">
            ...
            <div className="flex items-center justify-between mb-4 sm:mb-6">
              <p className="text-gray-600 text-sm sm:text-base">
                Showing {startIndex + 1}-{Math.min(startIndex + itemsPerPage, filteredAndSortedGames.length)} of {filteredAndSortedGames.length} PC games
              </p>
            </div>
            ...
            {filteredAndSortedGames.length === 0 ? (
              <div className="text-center py-12">
                <p className="text-gray-600">No PC games found matching your criteria.</p>
              </div>
            ) : viewMode === 'grid' ? (
