...
const PCGamesPage: React.FC<PCGamesPageProps> = ({
  onGameClick,
  onBackToHome,
}) => {
  ...
  const pcGames = useMemo(() => {
    return games.filter((game) => getPlatformsForGame(game).includes("PC"));
  }, [games]);
  ...
  const filteredAndSortedGames = useMemo(() => {
    ...
    return filtered;
  }, [pcGames, searchQuery, priceRange, sortBy]);
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-orange-50">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 py-4 sm:py-6 md:py-8">
          ...
          <div className="text-center py-12">
            ...
            <p className="mt-4 text-gray-600">Loading PC games...</p>
          </div>
        </div>
      </div>
    );
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 py-4 sm:py-6 md:py-8">
          ...
          <div className="text-center py-12">
            <p className="text-red-600">
              Failed to load PC games. Please try again later.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="lg:col-span-3">
            <div className="flex items-center justify-between mb-4 sm:mb-6">
              <p className="text-gray-600 text-sm sm:text-base">
                ...
                {filteredAndSortedGames.length} PC games
              </p>
            </div>
            ...
            {filteredAndSortedGames.length === 0 ? (
              <div className="text-center py-12">
                <p className="text-gray-600">
                  No PC games found matching your criteria.
                </p>
              </div>
            ) : viewMode === "grid" ? (
