...
const FlashSaleStrip: React.FC = () => {
  ...
  return (
    <div className="fixed top-0 w-full z-[60] bg-gradient-to-r from-red-600 via-orange-600 to-red-600 text-white shadow-lg">
      <div className="container mx-auto px-2 sm:px-4">
       <div className="flex flex-wrap items-center justify-between py-2 gap-2 sm:gap-4">
  {/* Flash Icon + Text */}
  <div className="flex items-center space-x-2 flex-shrink-0">
    <div className="bg-yellow-400 p-1 rounded-full animate-pulse">
  ...
  {/* Countdown */}
  <div className="flex items-center space-x-1 bg-black/20 rounded px-2 py-1">
  ...
  {/* Coupon Code */}
  <div className="flex items-center space-x-2 bg-white/20 rounded-lg px-3 py-1 flex-shrink-0">
    <span className="text-xs sm:text-sm font-semibold whitespace-nowrap">Code:</span>
    <button
