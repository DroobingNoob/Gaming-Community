...
const GamesPage: React.FC = () => {
  ...
  const [tempSelectedPlatform, setTempSelectedPlatform] = useState("PC");
  ...
  }, [searchQuery, selectedPlatform, sortBy, currentPage, viewMode, searchParams, setSearchParams]);
